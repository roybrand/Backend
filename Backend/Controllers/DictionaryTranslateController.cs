...
namespace Backend.Controllers
{
    ...
    {
        TranslateDataContext context;

        IConfiguration configuration;

        public DictionaryTranslateController(TranslateDataContext context, IConfiguration configuration)
        {
        ...
        public IActionResult GetTables()
        {
            var result = (from translate in this.context.DicTranslations
                          ...
                          select new TablesNamesDto{TableName =  translate.TableName, Type = tableType.Type, LastUpdate = translate.LastUpdate.ToString().Substring(0, 11) }).ToList().Distinct();
        ...
        public IActionResult SendEmail([FromBody] JsonElement data)
        {
            try
            {
                ...
                bool result = emails.Send(function, exception, null);
        ...
        private bool sendEmail(string functionName, string exceptionDescription)
        {
            ...
            return emails.Send(functionName, exceptionDescription, null);
        }
    }
}
