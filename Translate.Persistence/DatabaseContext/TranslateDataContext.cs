...
public partial class TranslateDataContext : DbContext
{
    public TranslateDataContext()
    {
    }

    public TranslateDataContext(DbContextOptions<TranslateDataContext> options)
        : base(options)
    {
    }
